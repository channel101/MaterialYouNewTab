...
const ko = {
    ...
    // Section titles
    "personalizationSectionTitle": "개인화",
    "clockSectionTitle": "시계",
    "searchSectionTitle": "검색",
    "weatherSectionTitle": "날씨",
    ...
    "shortcutDefaultName": "바로가기 생성",
    "shortcutInputName": "바로가기 제목",
    "shortcutInputUrl": "바로가기 주소",
    "shortcutInputIcon": "맞춤 아이콘: URL 혹은 SVG (선택 사항)",
    "recentlyAddedBookmarks": "최근 추가된",
    ...
    "newQuoteOnRefreshText": "하루 명언",
    "newQuoteOnRefreshInfo": "새로고침 할 때마다 바뀌는 명언 대신, 하루에 하나의 명언만 보기",
    ...
    // Footer Toast
    "footerToastTitle": "하단에 배너가 보이시나요?",
    "footerToastMessage": "배너를 없애려면 오른쪽 마우스 클릭 후 '새 탭의 하단바 숨기기'를 누르세요.",
    ...
    "ProxyDisclaimer": "모든 프록시 기능은 기본적으로 꺼져 있습니다.\n\n검색 제안과 CORS 우회 프록시를 켜려면, 개인정보 보호를 위해 직접 프록시를 호스팅하는 걸 강력히 권장 합니다.\n\n기본 설정으로는 https://mynt-proxy.rhythmcorehq.com 프록시를 사용하지만, 이 경우 모든 데이터가 이 서비스를 거치게 되어 개인정보 문제가 생길 수 있습니다.",
    "GPSDisclaimer": "위치 데이터는 정확한 날씨를 보여주기 위해서만 사용됩니다. 브라우저 안에서만 임시로 저장되며, 다른 서비스와 공유되지 않고 저희 또한 볼 수 없어요.\n\nGPS를 켜면 확장 프로그램 내에서만 위치 정보를 공유하는 것에 동의하게 되는것 입니다.",
    "failedbackup": "백업 실패: ",
